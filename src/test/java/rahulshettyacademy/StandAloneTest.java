...
public class StandAloneTest {
	...
	public static <LoandingPage> void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("kanu12@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Abc@1234567890");
		...
		/////this line problem i dont understand)
